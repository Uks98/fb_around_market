...
class _MarketDetailPageConsumerState extends ConsumerState<MarketDetailPage> with FireBaseInitialize implements DetailStreamDataImpl {
  @override
          ...
          child: StreamBuilder(
            ...
            builder: (context, snapshot) {
              if(snapshot.hasData){
               ...
               final items = snapshot.data?.docs.map((e) => MarketData.fromJson(e.data()).copyWith(markerId: e.data()["markerId"]),).toList();
                          ...
                          StatefulBuilder(
                            builder: (context,setState) {
                              return DetailIconText(
                                ...
                                title: "즐겨찾기",
                                callBack: () async{
                                  await marketInteractionClass.getFavoritePlace(snapshot, setState,isFavorite,widget.docId);
                                },
                              );
                            }
                          ),
